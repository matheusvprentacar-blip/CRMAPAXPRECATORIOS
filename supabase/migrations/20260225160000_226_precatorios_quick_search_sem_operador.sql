-- =====================================================
-- MIGRATION 226: Busca rapida de precatorios sem operador
-- =====================================================
-- Regra:
-- - p_termo (busca rapida) NAO busca por nomes de operador/responsavel
-- - busca por operador ocorre apenas via p_responsavel_id (filtro avancado)
-- =====================================================
...
'Busca global de precatorios sem busca por operador no termo rapido.';
