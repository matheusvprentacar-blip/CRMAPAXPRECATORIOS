...
export async function POST(request: NextRequest) {
  try {
    ...
    const templatePath = path.join(
      ...
      "Procuracao_Cessao_Credito_TEMPLATE.docx"
    )
    ...
    return new NextResponse(docxBuffer, {
      ...
      headers: {
        ...
        "Content-Disposition": `attachment; filename="Procuracao_Cessao_Credito.docx"`,
      },
    })
  } catch (error) {
    console.error("[gerar-procuracao] Erro:", error)
    return NextResponse.json(
