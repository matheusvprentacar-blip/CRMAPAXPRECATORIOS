...
export const KANBAN_COLUMNS: Array<{
  ...
  },
  {
    ...
    statusIds: ["analise_processual_inicial", "juridico"],
    color: {
  ...
  },
  {
    ...
    meta: "Pausados, sem interesse, reprovados ou não elegíveis",
    statusIds: ["pos_fechamento", "pausado_credor", "pausado_documentos", "sem_interesse", "reprovado", "nao_elegivel"],
    color: {
