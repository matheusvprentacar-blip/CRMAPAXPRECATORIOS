    ...
    <Card className="border-t-4 border-t-blue-600 shadow-lg">
      <CardHeader>
        <div className="flex justify-between items-start">
          ...
          <ToggleGroup
            type="single"
            value={isIsentoIrpf ? "irpf" : isManual ? "manual" : ""}
            onValueChange={(v) => {
              if (v === "manual") {
                setIsManual(true)
            ...
            className={`inline-flex w-full max-w-md items-center rounded-full bg-muted p-1 ${hasModoSelecionado ? "ring-1 ring-border" : "ring-2 ring-primary/40"}`}
          >
            <ToggleGroupItem
              value="manual"
              className={`flex-1 rounded-full px-4 py-2 text-sm font-medium text-muted-foreground transition-all hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 border border-transparent ${hasModoSelecionado ? "" : "border-border/60"} data-[state=on]:bg-primary data-[state=on]:text-primary-foreground data-[state=on]:shadow-sm data-[state=on]:ring-1 data-[state=on]:ring-primary/30 data-[state=on]:border-transparent`}
            >
              Modo Manual
            </ToggleGroupItem>
            <ToggleGroupItem
              value="irpf"
              className={`flex-1 rounded-full px-4 py-2 text-sm font-medium text-muted-foreground transition-all hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 border border-transparent ${hasModoSelecionado ? "" : "border-border/60"} data-[state=on]:bg-emerald-600 data-[state=on]:text-white data-[state=on]:shadow-sm data-[state=on]:ring-1 data-[state=on]:ring-emerald-600/30 data-[state=on]:border-transparent`}
            >
              Isento de IRPF
            </ToggleGroupItem>
          </ToggleGroup>
              ...
              <Card className="bg-white border-blue-100 shadow-sm">
                ...
                <CardContent className="p-0 text-sm">
                  <div className="divide-y divide-slate-100">
                    ...
                    <div className="flex justify-between p-2 px-4"><span className="text-slate-500">SELIC (até 2024)</span> <span>{fmt(preview.val_Selic)}</span></div>
                    <div className="flex justify-between p-2 px-4"><span className="text-slate-500">EC 136/2025 (IPCA 2025)</span> <span>{fmt(preview.val_EC136)}</span></div>
              ...
              <Card className="bg-white border-red-100 shadow-sm">
                ...
                <CardContent className="p-0 text-sm">
                  <div className="divide-y divide-slate-100">
                    ...
                    <div className="flex justify-between p-2 px-4"><span className="text-slate-500">Base (Princ + IPCA + SELIC + EC136)</span> <span>{fmt(preview.baseCorrecoes)}</span></div>
